...
/**
 * Format validator Diagnostics into location-tagged lines (one per finding). Empty in →
 * empty string out, so the caller can print a clean bill of health instead.
 */
