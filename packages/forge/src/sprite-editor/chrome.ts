...
// line, rect, ellipse, select, move, paste). Fill/select/move/paste land in
// sibling slices; the anchor tool moved off the number row (it lives in the
// playback box's `A anchor` and the `a` key).
