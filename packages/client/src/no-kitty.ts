...
// The blocking, press-any-key notice (ADR 0024 §3). Modeled on Controls: an absolute,
// centered panel on the modal layer (zIndex 30 — above the Shop/Controls/AudioOptions
// z20 modals, since this must sit over anything, e.g. the character creator). It carries
// NO dismissal state of its own beyond visibility: shown fresh each launch when detection
// confirms no-Kitty, dismissed by the first key press, never persisted.
