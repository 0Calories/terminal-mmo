...
// Registry indices — how many cosmetic Forms / hats exist, the metadata cosmetics
// validation clamps against. The art registries in @mmo/render must match these
// counts (guarded by a render-side test).
