...
import { DEFAULT_COSMETICS } from '../entities/cosmetics';
import { type PlayerState, spawnPlayerState } from '../entities/player';
import type { Entity, Input } from '../entities/types';
...
import { type AvatarIntent, type ServerAvatar, stepZone } from '../zones/zone';
